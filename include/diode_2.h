...
New version, with more potentials and actually using Welford-West algorithm.
...
double
harm_and_phi4_potential(double x, double k)
{
    /* Force due to a phi4 potential with harmonic term */
    return -k*(x-pow(x,3));
}
...
{    
    ...
    if (strcmp(potential_name,"none")==0){ functionPtr = no_potential; }
    else if (strcmp(potential_name,"cosine")==0){ functionPtr = cosine_potential; }
    else if (strcmp(potential_name,"phi4")==0){ functionPtr = phi_4_potential; }
    else if (strcmp(potential_name, "harm_phi4")==0){ functionPtr = harm_and_phi4_potential; }
    else { functionPtr = no_potential; }
